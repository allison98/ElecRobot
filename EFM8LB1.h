...
// INTERRUPT ENABLE FOR TIMER 4 and 5 (made by yours truly)
__sbit __at (0xF3+0) ES1   ; // UART1 Interrupt Enable
__sbit __at (0xF3+1) EI2C0   ; // I2C0 Slave Interrupt Enable
__sbit __at (0xF3+2) ET4; // Timer 4 Interrupt ENABLE
__sbit __at (0xF3+3) ET5; // Timer 5 Interrupt ENABLE
__sbit __at (0xF3+4) CL0; // Configurable Logic interrupt enable

__sbit __at (0xE6+0) ESMB0;
__sbit __at (0xE6+1) EMAT;
__sbit __at (0xE6+2) EWADC0;
__sbit __at (0xE6+3) EADC0;
__sbit __at (0xE6+4) EPCA0;
__sbit __at (0xE6+5) ECP0;
__sbit __at (0xE6+6) ECP1;
__sbit __at (0xE6+7) ET3; // Timer 3 interrupt enable
