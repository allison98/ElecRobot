...
void LCDprint_column(char* string, unsigned char line, unsigned char column, bit clear)
{
int j;
int k=column-1;
...
void Convert_to_ascii(char* string, unsigned int num, unsigned int size){
...
void main (void)
{
	...
	float period1, period,peak, peak1;
	float testRMS, refRMS;
	//float pulse_width,phase_diff;
	float frequency;
	
	float overflow_diff;
	
	float phase_diff, time_diff;
	
	//char phase_diff_str[4], testRMS_str[4], refRMS_str[4];
    char message[10];
