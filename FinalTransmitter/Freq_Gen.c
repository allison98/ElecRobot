/* transmitter code for the magnetic field controlled robot using the PIC32*/
			...
			//Stop //works great
				...
				while(1){
					...
					if((voltagex>=1.4 && voltagex<=1.8) && (voltagey>=1.4 && voltagey<=1.8)) {
						...
						T1CONbits.ON = 1; // exit while loop and turn square wave back on
						break;	
					}
				}
			}			
