...
"C:\CrossIDE\Call51\Bin\c51.exe" --use-stdout  "C:\Users\allisony\Documents\ElecRobot\sensor.c"
if not exist hex2mif.exe goto done
if exist sensor.ihx hex2mif sensor.ihx
if exist sensor.hex hex2mif sensor.hex
:done
echo done
echo Crosside_Action Set_Hex_File C:\Users\allisony\Documents\ElecRobot\sensor.hex
=======
<<<<<<< HEAD
...
>>>>>>> 3c574dd647f819c6ffa83734a09d1e02fb3c38ff
>>>>>>> ca8430264804405dda23573db6ee15eb310661bb
